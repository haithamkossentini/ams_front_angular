...
export class TokenInterceptorService implements HttpInterceptor {
 ...
 const basicToken: any = sessionStorage.getItem('basicToken'); // This retrieves a token from local storage
 ...
 req = req.clone({ headers: req.headers.set('Authorization', basicToken) });
